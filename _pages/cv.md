...
Designed and estimated open-economy DSGE models using Bayesian methods to assess climate-fiscal reforms and net-zero transition strategies in emerging markets, including Turkiye and Brazil. Performed quantitative policy analysis and counterfactual simulations under alternative fiscal consolidation and carbon pricing scenarios.
...
* **Ph.D., Economics**, New School for Social Research, New York, May 2021  
  Dissertation: "A Sectoral Approach to Measuring U.S. Growth, Inequality, and the Output Gap"  
  Fields: Macroeconomics and Econometrics
* **M.Phil., Economics**, New School for Social Research, New York, Aug 2019
* **M.Sc., Economics**, Middle East Technical University, Ankara, July 2016  
  Thesis: "An Evaluation of the Trilemma: Global Constraints on Monetary Policy in the Post-Bretton Woods Era"
* **B.Sc., Mathematics**, Middle East Technical University, Ankara, Jan 2011

Research Fields
======

Macroeconomic Modeling; Structural and Semi-Structural Models; Climate Macroeconomics; Fiscal Policy; Open-Economy Dynamics; Forecasting; Business Cycles
...
<ul>{% for post in site.publications reversed %}{% if post.category == "workingpapers" %}
  {% include archive-single-cv.html %}
{% endif %}{% endfor %}</ul>
...
* Frieda Wunderlich Award for Outstanding Dissertation by an International Student, 2021
* Dissertation Fellowship, 2019-2020
* Provost Scholarship, 2016-2018
* Scientific and Technological Research Council of Turkey Scholarship, 2006-2010

Technical Skills
======

MATLAB/Dynare; EViews; R; LaTeX
